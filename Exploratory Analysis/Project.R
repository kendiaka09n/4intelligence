...
agro <- read.csv('C:/Users/kendi/Downloads/Challenge_4i/data_comexstat.csv', encoding = "Latin3")
...
#R: As the question 4, we can analyze the by the total amount (US$) exported, which we can number the top 5 states Mato Grosso, Paraná, São Paulo, Rio Grande do Sul and Goiás.
